package com.luum.michi.app.mediaDetail.presentation.media
...
import com.luum.michi.app.mediaDetail.presentation.media.components.CharactersTab
import com.luum.michi.app.mediaDetail.presentation.media.components.ConnectionsTab
import com.luum.michi.app.mediaDetail.presentation.media.components.MediaDetailHeader
import com.luum.michi.app.mediaDetail.presentation.media.components.OverviewTab
import com.luum.michi.app.mediaDetail.presentation.media.components.StaffTab
import com.luum.michi.app.mediaDetail.presentation.media.components.StatsTab
...
internal fun MediaDetailScreen(
    ...
    when {
        ...
        stateHolder.isLoading -> ListLoading(label = strings.mediaDetailLoadingLabel)
        ...
        else -> ListLoading(label = strings.mediaDetailLoadingLabel)
    }
}
