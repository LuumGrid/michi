...
object PlatformIcons {
    //Navbar
    val Animation: Painter @Composable get() = painterResource(Res.drawable.tv)
    val Reading: Painter @Composable get() = painterResource(Res.drawable.library)
    val Home: Painter @Composable get() = painterResource(Res.drawable.explore)
    val Feed: Painter @Composable get() = painterResource(Res.drawable.dynamic_feed)
