...
import com.luum.michi.app.core.anilist.medialist.parseMediaListStatus
import com.luum.michi.app.core.anilist.medialist.toApiValue
        ...
        return graphQLClient.execute(request) { dataJson ->
            ...
            MediaListViewerEntry(
                ...
                startedAtMillis = entry?.startedAt?.let {
                    ...
                    if (y != null && m != null && d != null) com.luum.michi.app.core.model.calendarPartsToMillis(
