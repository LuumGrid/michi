...
import com.luum.michi.app.resources.library
...
import com.luum.michi.app.resources.person
...
import com.luum.michi.app.resources.sort_list
...
object Icons {
    //tabBar
    val Anime: Painter @Composable get() = painterResource(Res.drawable.tv)
    val Manga: Painter @Composable get() = painterResource(Res.drawable.library)
    val Discover: Painter @Composable get() = painterResource(Res.drawable.explore)
    val Account: Painter @Composable get() = painterResource(Res.drawable.person)

    val Search: Painter @Composable get() = painterResource(Res.drawable.search)
    val Filter: Painter @Composable get() = painterResource(Res.drawable.filter_list)
    val Sort: Painter @Composable get() = painterResource(Res.drawable.sort_list)
