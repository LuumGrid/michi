...
val IconPack.Groups: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Groups",
        defaultWidth = 24.dp,
        defaultHeight = 24.dp,
        ...
        path(fill = SolidColor(Color(0xFFE3E3E3))) {
            ...
            quadToRelative(-55f, 0f, -100.5f, 15f)
            reflectiveQuadTo(325f, 640f)
            close()
            moveTo(160f, 520f)
