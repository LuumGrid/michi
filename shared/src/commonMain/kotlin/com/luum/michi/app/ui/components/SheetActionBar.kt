...
internal enum class ActionButtonEmphasis { FILLED, OUTLINED }
...
internal fun SheetActionBar(
    ...
    leadingEmphasis: ActionButtonEmphasis = ActionButtonEmphasis.OUTLINED,
    trailingEmphasis: ActionButtonEmphasis = ActionButtonEmphasis.FILLED,
...
private fun RowScope.ActionBarButton(
    ...
    val buttonModifier = Modifier
        .weight(1f)
        .height(48.dp)
    if (emphasis == ActionButtonEmphasis.FILLED) {
        Button(
            onClick = onClick,
            enabled = enabled,
